    ...
    <>
      <section id="module-analysis" className="module-pane active w-full"><div className="space-y-6">
        ...
        <div className="bg-slate-800/60 border border-slate-700 rounded-xl p-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          ...
          <div>
            <button
              onClick={() => window.location.hash = '#/detailed-analytics'}
        ...
        {/* Thống kê chi tiết button */}
        <div className="bg-gradient-to-r from-slate-800/60 to-slate-700/60 border border-slate-600/50 rounded-xl p-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-slate-200">Phân Tích Sâu</h3>
                <p className="text-sm text-slate-400">Xem biểu đồ và thống kê chi tiết từng tiêu chí đánh giá</p>
              </div>
            </div>
            <button
              onClick={() => window.location.hash = '#/detailed-analytics'}
              className="flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-white font-semibold rounded-xl transition-all duration-200 shadow-lg hover:shadow-blue-500/25 transform hover:scale-105"
            >
