      ...
      <div className="flex items-center justify-center p-4 sm:p-6 lg:p-8">
        <div className="w-full max-w-7xl">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-blue-500 via-purple-600 to-cyan-500 rounded-2xl mb-6 shadow-lg">
            ...
            <p className="text-slate-300 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
              Thiết lập tiêu chí lọc và phân bổ trọng số để tối ưu hóa quá trình đánh giá ứng viên
            </p>
          </div>
                ...
                <div className="flex items-center justify-between mb-8">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400">Thiết lập các điều kiện bắt buộc để lọc ứng viên phù hợp</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between mb-8">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400">Thiết lập tỷ trọng đánh giá cho từng tiêu chí quan trọng</p>
                    </div>
                  </div>
