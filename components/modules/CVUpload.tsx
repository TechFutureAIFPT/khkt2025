      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-slate-900/50 via-slate-800/80 to-slate-900/50 border border-slate-700/50 rounded-3xl shadow-2xl backdrop-blur-xl">
        ...
        <div className="relative z-10 p-8 md:p-12 space-y-8">
          ...
          <div className="text-center space-y-4">
            ...
            <div>
              <h2 className="text-3xl font-bold text-white mb-2">Tải lên CV ứng viên</h2>
              <p className="text-slate-400 text-lg">Chọn các file CV để bắt đầu quá trình phân tích thông minh</p>
            </div>
          </div>
            ...
            >
              <div className="text-center space-y-4">
                ...
                <div>
                  ...
                  <p className="text-slate-400 mb-3">Hỗ trợ định dạng: PDF, DOC, DOCX, TXT, JPG, PNG</p>
