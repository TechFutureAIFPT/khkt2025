      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-slate-800/50 p-6 rounded-xl border border-slate-700">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 p-3 bg-slate-900/50 rounded-lg">
                ...
                <div>
                  <p className="text-sm text-slate-200 font-medium">Điểm Mạnh</p>
                  <p className="text-xs text-slate-400 mt-1">
                    {analyticsData.gradeStats.A > 0 ? 
                      `Có ${analyticsData.gradeStats.A} ứng viên đạt hạng A (${Math.round(analyticsData.gradeStats.A / analyticsData.totalCandidates * 100)}%)` :
                      'Cần cải thiện tiêu chí tuyển dụng để có thêm ứng viên chất lượng cao'
                    }
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-slate-900/50 rounded-lg">
                <div className="w-6 h-6 bg-blue-500/20 rounded-full flex items-center justify-center mt-0.5">
                  <i className="fa-solid fa-info text-blue-400 text-xs"></i>
                </div>
                <div>
                  <p className="text-sm text-slate-200 font-medium">Phân Tích</p>
                  <p className="text-xs text-slate-400 mt-1">
                    Tiêu chí có điểm cao nhất: {analyticsData.criteriaAverages.sort((a, b) => b.average - a.average)[0]?.fullCriterion || 'N/A'}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-slate-900/50 rounded-lg">
                <div className="w-6 h-6 bg-orange-500/20 rounded-full flex items-center justify-center mt-0.5">
                  <i className="fa-solid fa-exclamation text-orange-400 text-xs"></i>
                </div>
                <div>
                  <p className="text-sm text-slate-200 font-medium">Cần Cải Thiện</p>
                  <p className="text-xs text-slate-400 mt-1">
                    Tiêu chí có điểm thấp nhất: {analyticsData.criteriaAverages.sort((a, b) => a.average - b.average)[0]?.fullCriterion || 'N/A'}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-slate-800/50 p-6 rounded-xl border border-slate-700">
            ...
            <div className="space-y-3">
              <button className="w-full flex items-center gap-3 p-3 bg-slate-900/50 hover:bg-slate-900/70 rounded-lg transition-colors duration-200">
                <div className="w-8 h-8 bg-green-500/20 rounded-lg flex items-center justify-center">
                  <i className="fa-solid fa-file-excel text-green-400 text-sm"></i>
                </div>
                <div className="text-left">
                  <p className="text-sm text-slate-200 font-medium">Xuất Excel</p>
                  <p className="text-xs text-slate-400">Báo cáo chi tiết với biểu đồ</p>
                </div>
              </button>
              ...
              <button className="w-full flex items-center gap-3 p-3 bg-slate-900/50 hover:bg-slate-900/70 rounded-lg transition-colors duration-200">
                ...
                <div className="text-left">
                  <p className="text-sm text-slate-200 font-medium">Xuất PDF</p>
                  <p className="text-xs text-slate-400">Báo cáo tổng kết</p>
                </div>
              </button>
              ...
              <button className="w-full flex items-center gap-3 p-3 bg-slate-900/50 hover:bg-slate-900/70 rounded-lg transition-colors duration-200">
                ...
                <div className="text-left">
                  <p className="text-sm text-slate-200 font-medium">Lưu Biểu Đồ</p>
                  <p className="text-xs text-slate-400">Xuất các biểu đồ dạng hình ảnh</p>
                </div>
              </button>
            </div>
          </div>
        ...
        <div className="mt-8 text-center">
          <button 
            ...
            className="px-6 py-3 bg-slate-700 hover:bg-slate-600 text-slate-200 rounded-lg border border-slate-600 transition-colors duration-200 flex items-center gap-2 mx-auto"
          >
            <i className="fa-solid fa-arrow-left"></i>
            Quay Lại Kết Quả Phân Tích
          </button>
        </div>
      </div>
    </div>
