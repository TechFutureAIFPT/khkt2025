...
const Footer: React.FC = () => {
  ...
  const projectLinks = [
    {
      name: 'HR Support 1.0',
      url: 'https://github.com/TechFutureAIFPT/THTMienBac',
      description: 'Phiên bản đầu tiên'
    },
    {
      name: 'HR Support 2.0',
      url: 'https://github.com/TechFutureAIFPT/THTToanQuoc2025',
      description: 'Mở rộng toàn quốc'
    },
    {
      name: 'Parse JD 1.0',
      url: 'https://github.com/TechFutureAIFPT/ParseJD-',
      description: 'Công cụ phân tích JD'
    },
    {
      name: 'HR Support 3.0',
      url: 'https://github.com/TechFutureAIFPT/hr-support',
    ...
    <footer className="bg-slate-900/50 border-t border-slate-700/50 backdrop-blur-sm mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Research Projects */}
          <div className="space-y-4">
            <h4 className="text-lg font-semibold text-slate-200">Dự án Research</h4>
